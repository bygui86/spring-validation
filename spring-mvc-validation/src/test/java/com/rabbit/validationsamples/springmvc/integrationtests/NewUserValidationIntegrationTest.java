package com.rabbit.validationsamples.springmvc.integrationtests;

import com.rabbit.validationsamples.springmvc.controllers.NewUserController;
...
public class NewUserValidationIntegrationTest {
	...
	public void setup() {
		...
		mockMvc = MockMvcBuilders.standaloneSetup(new NewUserController()).build();
	}
